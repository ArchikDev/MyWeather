package com.example.myweather.presentation.details
...
import com.example.myweather.domain.usecase.GetForecastUseCase
import com.example.myweather.domain.usecase.ObserveFavouriteStateUseCase
import com.example.myweather.presentation.details.DetailsStore.Intent
import com.example.myweather.presentation.details.DetailsStore.Label
import com.example.myweather.presentation.details.DetailsStore.State
import com.example.myweather.presentation.search.SearchStore
...
class DetailsStoreFactor @Inject constructor(
                ...
                Intent.ClickChangeFavouriteStatus -> {
                    scope.launch {
                        ...
                        if (state.isFavourite) {
                            ...
                            changeFavouriteStateUseCase.addFavourite(state.city)
                        }
                    }
                }
            }
