...
import com.example.myweather.presentation.details.DetailsStoreFactor
import com.example.myweather.presentation.search.SearchStore.Intent
import com.example.myweather.presentation.search.SearchStore.Label
import com.example.myweather.presentation.search.SearchStore.State
                ...
                is Intent.ClickCity -> {
                    when (openReason) {
                        OpenReason.AddToFavourite -> {
                            scope.launch {
                                changeFavouriteStateUseCase.addFavourite(intent.city)
